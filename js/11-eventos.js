...
- Cambiar las imagénes (al hacer click) por otras que tengamos en nuestra carpeta (deberemos cambiar el atributo src) (Solo si sobra tiempo)
*/
...
function verde() {this.style.background = 'LightGreen'};
document.getElementById('s1').addEventListener('click', verde);
...
//     articulos[i].addEventListener('click', function() {this.style.background = 'PaleTurquoise'});
// };

function texto() {document.getElementById('p1').innerText = "Nuevo párrafo"};
document.getElementById('b1').addEventListener('click', texto);
...
//     imagenes[i].addEventListener('click', function() {this.setAttribute('src', 'img/foto3.jpg')});
// };
